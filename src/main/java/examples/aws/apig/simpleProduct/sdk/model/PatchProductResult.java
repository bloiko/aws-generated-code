...
public class PatchProductResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PatchProductResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PatchProductResult == false)
            return false;
        PatchProductResult other = (PatchProductResult) obj;
    ...
    @Override
    public PatchProductResult clone() {
        try {
            return (PatchProductResult) super.clone();
