...
public class SimpleProductSdkException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new SimpleProductSdkException with the specified error message.
     *
     * @param message
     *        Describes the error encountered.
     */
    public SimpleProductSdkException(String message) {
        super(message);
        this.message = message;
    }

    @Override
    public SimpleProductSdkException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
